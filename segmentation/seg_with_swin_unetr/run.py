...
#     num_classes = 4 
#     in_channels = 4 
#     log_dir = "swin_unetr_v2/logs/swin_unetr_v2"
#     ckpt_dir = "swin_unetr_v2/checkpoints/swin_unetr_v2"
...
#     train_loader = get_dataloader(train_dir, batch_size=batch_size, is_train=True, spatial_size=spatial_size, num_workers=2, cache_num=336)
